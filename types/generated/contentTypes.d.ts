...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['principal', 'promotions', 'test']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBlogArticleBlogArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blog_user: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiBuyComplementBuyComplement
  extends Struct.CollectionTypeSchema {
  collectionName: 'buy_complements';
  info: {
    description: '';
    displayName: 'buy_complement';
    pluralName: 'buy-complements';
    singularName: 'buy-complement';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    buy_status: Schema.Attribute.Enumeration<
      ['pendiente', 'aprobado', 'cancelado', 'en revisi\u00F3n']
    > &
      Schema.Attribute.DefaultTo<'pendiente'>;
    combo: Schema.Attribute.String & Schema.Attribute.DefaultTo<'null'>;
    complements: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discount_coupon: Schema.Attribute.String;
    ...
    installment: Schema.Attribute.Integer;
    installment_amount: Schema.Attribute.Integer;
    last_name: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::buy-complement.buy-complement'
    > &
      Schema.Attribute.Private;
...
export interface ApiBuyGiftcardBuyGiftcard extends Struct.CollectionTypeSchema {
  collectionName: 'buy_giftcards';
  info: {
    description: '';
    displayName: 'buy_giftcard';
    pluralName: 'buy-giftcards';
    singularName: 'buy-giftcard';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    giftCardId: Schema.Attribute.String & Schema.Attribute.Required;
    giverName: Schema.Attribute.String & Schema.Attribute.Required;
    guestId: Schema.Attribute.String;
    guestLastName: Schema.Attribute.String;
    guestName: Schema.Attribute.String;
    idJanosCrm: Schema.Attribute.Integer & Schema.Attribute.Required;
    imageUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::buy-giftcard.buy-giftcard'
    > &
      Schema.Attribute.Private;
    message: Schema.Attribute.String;
    mpPaymentId: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    paymentDetails: Schema.Attribute.JSON;
    paymentStatus: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiComplementCategoryComplementCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::complement-category.complement-category'
    > &
      Schema.Attribute.Private;
...
export interface ApiComplementoComplemento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    complement_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::complement-category.complement-category'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiDiscountTypeDiscountType
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::discount-type.discount-type'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDiscountDiscount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discount_type: Schema.Attribute.Relation<
      'manyToOne',
      'api::discount-type.discount-type'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEventTypeEventType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gift_card_images: Schema.Attribute.Relation<
      'oneToMany',
      'api::gift-card-image.gift-card-image'
    >;
    icon: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    id_janos_crm: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiGiftCardImageGiftCardImage
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    back_image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPackPack extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    complements_id: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discount_percentage: Schema.Attribute.Integer & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pack.pack'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    pack_id: Schema.Attribute.UID<'name'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSpaceSpace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    quantity_formal: Schema.Attribute.Integer;
    subtitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::buy-complement.buy-complement': ApiBuyComplementBuyComplement;
      'api::buy-giftcard.buy-giftcard': ApiBuyGiftcardBuyGiftcard;
      'api::client.client': ApiClientClient;
      'api::complement-category.complement-category': ApiComplementCategoryComplementCategory;
      'api::complemento.complemento': ApiComplementoComplemento;
      'api::discount-type.discount-type': ApiDiscountTypeDiscountType;
      'api::discount.discount': ApiDiscountDiscount;
      'api::event-type.event-type': ApiEventTypeEventType;
      'api::feature.feature': ApiFeatureFeature;
      'api::gift-card-image.gift-card-image': ApiGiftCardImageGiftCardImage;
